...
import { useBackUploadManager } from "@rn-lalala/upload"
import {
  CacheAnswerDocument,
...
import type { SopFormInstance } from "@rn-lalala/sop"
...
const SopFormPro = forwardRef<SopFormProState, IProps>(
  ({ uuid, businessId, sopIds, title }, ref) => {
    ...
    const setFinishedTask = useBackUploadManager(
      (state) => state.setFinishedTask,
    )
